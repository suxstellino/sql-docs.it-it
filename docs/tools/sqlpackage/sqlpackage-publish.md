---
title: Publish SqlPackage
description: Informazioni su come automatizzare le attività di sviluppo di database con Publish di SqlPackage.exe. È possibile visualizzare esempi, oltre a parametri, proprietà e variabili SQLCMD disponibili.
ms.prod: sql
...
## <a name="parameters-for-the-publish-action"></a>Parametri per l'azione Publish

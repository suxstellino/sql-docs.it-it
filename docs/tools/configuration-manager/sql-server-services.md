---
title: Servizi di SQL Server
description: Acquisire familiarità con le finestre di dialogo dei servizi SQL Server in Gestione configurazione SQL Server.

...
##  <a name="improved-security"></a>Sicurezza migliorata  
 ...
 Durante l'aggiornamento a [!INCLUDE[sssql15-md](../includes/sssql16-md.md)][!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)], le autorizzazioni precedenti vengono convertite nelle nuove autorizzazioni, come illustrato nella tabella seguente.  
...
## <a name="improved-troubleshooting"></a>Risoluzione dei problemi migliorata  
 ...
 In [!INCLUDE[sssql15-md](../includes/sssql16-md.md)][!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)]sono state aggiunte funzionalità per migliorare il debug e semplificare la risoluzione dei problemi. Per altre informazioni, vedere [Traccia &#40;Master Data Services&#41;](../master-data-services/tracing-master-data-services.md).  

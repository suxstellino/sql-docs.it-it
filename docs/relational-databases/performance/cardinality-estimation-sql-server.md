...
In alternativa, a partire da [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] SP1, l'[hint per la query](../../t-sql/queries/hints-transact-sql-query.md#use_hint) `USE HINT ('FORCE_LEGACY_CARDINALITY_ESTIMATION')`.
...
**Query Store:** a partire da [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)], Query Store è uno strumento utile per esaminare le prestazioni delle query. In [!INCLUDE[ssManStudio](../../includes/ssManStudio-md.md)] in **Esplora oggetti** nel nodo del database viene visualizzato un nodo **Query Store** quando Query Store è abilitato.  

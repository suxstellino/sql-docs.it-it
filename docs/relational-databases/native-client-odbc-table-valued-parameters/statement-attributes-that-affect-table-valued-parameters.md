---
description: Attributi dell'istruzione che influiscono sui parametri con valori di tabella
title: Attributi che interessano i parametri di Table-Valued
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql

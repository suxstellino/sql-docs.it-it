...
|timestamp_utc|**datetime2**|**SI APPLICA A**: [!INCLUDE[sssql17](../../includes/sssql17-md.md)] e versioni successive e [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)].<br /><br />Data e ora (fuso orario UTC) dell'evento. Non ammette i valori Null.|  

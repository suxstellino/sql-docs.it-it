...
|Passaggio 6. Eseguire l'autenticazione in Azure, se la chiave master della colonna corrente o la nuova chiave master della colonna è archiviata in un insieme di credenziali delle chiavi o in un modulo di protezione HSM gestito in Azure Key Vault | [Add-SqlAzureAuthenticationContext](/powershell/sqlserver/sqlserver/vlatest/add-sqlazureauthenticationcontext) | Sì | No
...
|Passaggio 6. Eseguire l'autenticazione in Azure, se la chiave master della colonna precedente (corrente) o la nuova chiave master della colonna è archiviata in un insieme di credenziali delle chiavi o in un modulo di protezione HSM gestito in Azure Key Vault. | [Add-SqlAzureAuthenticationContext](/powershell/sqlserver/sqlserver/vlatest/add-sqlazureauthenticationcontext) | Sì | No
...
|Passaggio 3. Eseguire l'autenticazione in Azure, se la chiave master della colonna (che protegge la chiave di crittografia della colonna da ruotare) viene archiviata in un insieme di credenziali delle chiavi o in un modulo di protezione HSM gestito in Azure Key Vault. | [Add-SqlAzureAuthenticationContext](/powershell/sqlserver/sqlserver/vlatest/add-sqlazureauthenticationcontext) | Sì | No

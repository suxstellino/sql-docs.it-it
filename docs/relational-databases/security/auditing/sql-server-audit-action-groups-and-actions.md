...
### <a name="considerations"></a>Considerazioni  
 ...
 > [!NOTE]
 > A causa dell'overhead associato all'abilitazione del controllo a livello di transazione, a partire da [!INCLUDE[sssql16-md](../../../includes/sssql16-md.md)] SP2 CU3 e [!INCLUDE[ssSQL17](../../../includes/sssql17-md.md)] CU4, il controllo a livello di transazione è disabilitato per impostazione predefinita, a meno che la modalità di conformità ai criteri comuni non sia abilitata.  Se la modalità di conformità ai criteri comuni è disabilitata, sarà comunque possibile aggiungere un'azione da TRANSACTION_GROUP a una specifica di controllo, ma non verranno raccolte azioni di transazione.  A partire da [!INCLUDE[sssql16-md](../../../includes/sssql16-md.md)] SP2 CU3 e [!INCLUDE[ssSQL17](../../../includes/sssql17-md.md)] CU4 e versioni successive, se si intende configurare azioni di transazione da TRANSACTION_GROUP, assicurarsi che l'infrastruttura di controllo a livello di transazione sia abilitata procedendo all'abilitazione della modalità di conformità ai criteri comuni.  Tenere presente che in [!INCLUDE[sssql16-md](../../../includes/sssql16-md.md)] il controllo a livello di transazione può anche essere disabilitato con il flag di traccia 3427 a partire da SP1 CU2.

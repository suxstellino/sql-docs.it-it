...
## <a name="sssql16-md-and-later"></a>[!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] e versioni successive  
 Nella tabella seguente vengono descritte le colonne in `sys.dm_db_xtp_checkpoint_stats` , a partire da **[!INCLUDE[sssql16-md](../../includes/sssql16-md.md)]** .  

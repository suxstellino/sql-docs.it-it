...
|**softnuma_configuration**|**int**|**Si applica a**: [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] e versioni successive.<br /><br /> Specifica il modo in cui vengono configurati i nodi NUMA. Non ammette i valori NULL.<br /><br /> 0 = OFF indica l'impostazione predefinita dell'hardware<br /><br /> 1 = soft-NUMA automatizzato<br /><br /> 2 = Soft-NUMA manuale tramite il registro di sistema|  
|**softnuma_configuration_desc**|**nvarchar(60)**|**Si applica a**: [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] e versioni successive.<br /><br /> DISATTIVATO = la funzionalità Soft-NUMA è disattivata<br /><br /> ON = [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] determina automaticamente le dimensioni dei nodi NUMA per soft-NUMA<br /><br /> MANUAL = configurazione soft-NUMA manualmente|

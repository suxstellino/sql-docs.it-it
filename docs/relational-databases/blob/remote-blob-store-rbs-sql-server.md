...
| [!INCLUDE[sql-server-2019](../../includes/sssql19-md.md)] | [[!INCLUDE[sql-server-2019](../../includes/sssql19-md.md)] Pagina di download di RBS](https://go.microsoft.com/fwlink/?linkid=2109005) |
| &nbsp; | &nbsp; |
...
-   RBS 2016 usa una chiave simmetrica **AES_128** . [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] non consente la creazione di nuove chiavi **TRIPLE_DES** , se non per motivi di compatibilità con le versioni precedenti. Per altre informazioni, vedere [CREATE SYMMETRIC KEY &#40;Transact-SQL&#41;](../../t-sql/statements/create-symmetric-key-transact-sql.md).  

---
description: Proprietà, metodi ed eventi della raccolta Fields
title: Proprietà, metodi ed eventi della raccolta Fields | Microsoft Docs
ms.prod: sql

...
- **Integration Services:**  
     ...
     Eseguire la migrazione dei pacchetti di Integration Services al formato più recente. Per altre informazioni, vedere [Upgrade Integration Services Packages](../../integration-services/install-windows/upgrade-integration-services-packages.md).  

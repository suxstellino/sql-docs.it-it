...
> [!NOTE]
> A partire da [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] SP2, usare il flag di traccia 8079 per consentire a [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] di usare la configurazione soft-NUMA automatica. A partire da [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] questo comportamento è controllato dal motore e il flag di traccia 8079 non ha alcun effetto. Per altre informazioni, vedere [DBCC TRACEON - Flag di traccia](../../t-sql/database-console-commands/dbcc-traceon-trace-flags-transact-sql.md).
...
|Esempio per un server [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] con più gruppi K|Type|Nome del valore|Dati del valore|  
|-----------------------------------------------------------------------------------------------------------------|----------|----------------|----------------|  

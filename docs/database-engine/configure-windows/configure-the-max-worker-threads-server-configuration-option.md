...
-   La tabella seguente visualizza il numero massimo di thread di lavoro configurato automaticamente (quando il valore è impostato su 0) in base a diverse combinazioni di CPU, architettura del computer e versioni di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], usando la formula: **_Numero massimo di ruoli di lavoro predefiniti_ + ((* CPU logiche* - 4) * *Ruoli di lavoro per CPU*)**.  
    ...
    |Numero di CPU|Computer a 32 bit (fino a [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)])|Computer a 64 bit (fino a [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] SP1)|Computer a 64 bit (a partire da [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] SP2 e [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)])|   
    |------------|------------|------------|------------|  
    |\< = 4|256|512|512|   
    |8|288|576|576|   
    |16|352|704|704|   
    ...
    Fino a [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] SP1, i *Ruoli di lavoro per CPU* dipendono solo dall'architettura (a 32 bit o a 64 bit):
    ...
    A partire da [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] SP2 e [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)], i *Ruoli di lavoro per CPU* dipendono dall'architettura e dal numero di processori (compreso tra 4 e 64 o maggiore di 64):

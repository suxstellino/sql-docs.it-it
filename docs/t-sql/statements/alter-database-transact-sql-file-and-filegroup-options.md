...
|-------------|--------------------|
|A partire da [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)]|Dati 64 MB. File di log 64 MB.|
...
AUTOGROW_SINGLE_FILE **Si applica a**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ([!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] e versioni successive)

...
- [Estensione Kusto (KQL) per Azure Data Studio (anteprima)](../extensions/kusto-extension.md)
- [Creare ed eseguire un notebook Kusto (KQL) (anteprima)](./notebooks-kusto-kernel.md)

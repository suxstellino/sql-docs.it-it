...
description: Questo articolo fornisce i collegamenti alle informazioni per l'installazione delle funzionalità di SQL Server incluse nella piattaforma Microsoft Business Intelligence.
...
-   [Installare Analysis Services](/analysis-services/instances/install-windows/install-analysis-services)  
  
-   [Installazione di Analisi Services in modalità Power Pivot](/analysis-services/instances/install-windows/install-analysis-services-in-power-pivot-mode)  
...
> [!NOTE]
> SQL Server Data Tools (SSDT) non è incluso con SQL Server 2016. [Scaricare SQL Server Data Tools (SSDT)](../../ssdt/download-sql-server-data-tools-ssdt.md).
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Eseguire l'aggiornamento a SQL Server](../../database-engine/install-windows/upgrade-sql-server.md)  

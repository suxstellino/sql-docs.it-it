...
| HDFS-site. DFS. fornito. overreplication. Factor                              | Fattore di sovrareplica per le archiviazioni fornite.                                                       | float  | 1                                                                                      |
| HDFS-site. DFS. fornito. cache. Capacity. fraction                             | Frazione della capacità della cache per l'archiviazione specificata.                                                       | float  | 0.01                                                                                   |
...
| Core-site. Hadoop. Security. KMS. client. failover. max. Retries                  | Numero massimo di tentativi per il failover del client.                                                                    | INT    | 20                                                                                     || Zoo-cfg. tickTime                                       | Tempo di ciclo per la configurazione di ' ZooKeeper '.                         | INT    | 2000                |
